...
public class MainActivity extends AppCompatActivity implements CTInboxListener,DisplayUnitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CleverTapAPI.createNotificationChannel(getApplicationContext(),"biswa2","biswa2","biswa2", NotificationManager.IMPORTANCE_MAX,true);
...
//              Log.d("Count","Count"+cleverTapDefaultInstance.getInboxMessageCount());
        ...
        createu.setOnClickListener(view -> {
            ...
            profileUpdate.put("Name", "android");    // String
            profileUpdate.put("Identity", 3223);      // String or number
            profileUpdate.put("Email", "android@abc.com"); // Email address of the user
            profileUpdate.put("Phone", "+918800000711");   // Phone (with the country code, starting with +)
